...
open class Highlight: NSObject
{
    ...
    open override func isEqual(_ object: Any?) -> Bool
    {
        ...
        //Natali changed this!
        if (object! as! Int) != dataIndex //(object! as AnyObject).dataIndex != dataIndex
        {
            return false
        }
        
        if (object! as! Int) != _dataSetIndex //(object! as AnyObject).dataSetIndex != _dataSetIndex
        {
            return false
        }
        
        if (object! as! Int) != _stackIndex //(object! as AnyObject).stackIndex != _stackIndex
        {
            return false
        }
