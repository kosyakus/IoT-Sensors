...
- (void)updateLabelPositions {
    ...
    self.minLabel.frame = CGRectMake(0, 0, ceil(minLabelTextSize.width), ceil(minLabelTextSize.height));
    self.maxLabel.frame = CGRectMake(0, 0, ceil(maxLabelTextSize.width), ceil(maxLabelTextSize.height));
